...
<rdc:comment>
Description: Collect, validate and confirm a mortgage type.
Attributes:
...
minTerm: minimum allowed term
maxTerm: maximum allowed term
</rdc:comment>
...
<c:choose>
  <c:when test="${empty stateMap[id]}">
    ...
    <jsp:useBean id="model"
      class="org.apache.taglibs.rdc.MortgageType" >
