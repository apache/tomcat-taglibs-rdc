...
<rdc:comment>
  Description: Collect, validate and confirm a social security number.
  Attributes:
...
<c:choose>
  <c:when test="${empty stateMap[id]}">
    ...
    <jsp:useBean id="model" class="org.apache.taglibs.rdc.SocialSecurityNumber" >
