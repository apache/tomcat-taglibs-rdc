...
<rdc:comment>
Description: Collect, validate and confirm a currency value.
Attributes:
...
<c:choose>
  <c:when test="${empty stateMap[id]}">
    ...
    <jsp:useBean id="model"
      class="org.apache.taglibs.rdc.Currency" >
      ...
      <c:set target="${model}" property="grammar" value="builtin:grammar/currency"/>
