...
<c:choose>
 ...
 <% 
  Grammar[] grammarList = new Grammar[] {
    new Grammar("../../grammar/musicstore-app/genre_or_category.grxml", Boolean.FALSE, Boolean.FALSE, "mainGrammar"),
    new Grammar("../../grammar/musicstore-app/genre_or_category.grxml#category_only", Boolean.FALSE, Boolean.FALSE, "categoryGrammar")
  };
  pageContext.setAttribute("grammarList", grammarList);
 %>
 <vxml version="2.0" xml:lang="en-US"  xmlns="http://www.w3.org/2001/vxml" >
 ...
 <c:if test="${!(empty choice)}">
  <rdc:struts-submit submit="/listalbums.do" context="${pageContext}" namelist="choice" />
 </c:if>
 </c:otherwise>
</c:choose>
<!--Example:End-->
