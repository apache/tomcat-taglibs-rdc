...
<vxml version="2.0" xml:lang="en-US"  xmlns="http://www.w3.org/2001/vxml" >
  ...
  <rdc:task map="${dialogMap}">
    ...
    <block><prompt>${promptContent}</prompt></block>
    <rdc:select1 id="action" optionList="/config/musicstore-app/reviewcart/action-select.xml"
               config="/config/musicstore-app/reviewcart/action-cfg.xml" />
